...
<?php
	if(isset($_POST['submit'])){
		...
		$sql=mysqli_query($conn,"SELECT nPassword FROM nurse where nPassword='$oldpass' and nurse_ID='$id'");
		...
		if($num){
			...
			$con=mysqli_query($conn,"update nurse set nPassword='$newpass' where nurse_ID ='$id'");
