          ...
          <div class="sidebar__inner">
			...
			<div class="profile_info">
					<div class="img_holder">
						<?php echo "<img src='../img/profile/".$row['pProfilepic']."' >"; ?>
					</div>
					<br>
					<p class="title"><?php echo $row['pFullName']; ?></p>
					<p class="sub_title">PATIENT</p>
				</div>
            <ul class="lists">
              <li>
                <a href="home.php">
              ...
              <li>
                <a href="appointment.php">
                  <span class="title">Manage Appointment</span>
                </a>
              </li>
              <li>
			  <a href="report.php">
                  <span class="title">Health Report</span>
                </a>
              </li>
              <li>
