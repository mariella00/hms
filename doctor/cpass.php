...
<?php
	if(isset($_POST['submit'])){
		...
		$sql=mysqli_query($conn,"SELECT dPassword FROM doctor where dPassword='$oldpass' and doctor_ID='$id'");
		...
		if($num){
			...
			$con=mysqli_query($conn,"update doctor set dPassword='$newpass' where doctor_ID ='$id'");
